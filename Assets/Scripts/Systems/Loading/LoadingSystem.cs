    ...
    public class LoadingSystem : AppSystem
    {
        ...
        public void StartLoading()
        {
           ...
           //create Rocket command
            var RocketCommand = new LoadingCommand<RocketModel>(ApiList.Rockets);
            RocketCommand.OnComplete += result => _models.rocket = result;
            _invoker.AddCommand(RocketCommand);
